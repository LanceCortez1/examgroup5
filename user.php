        ...
        <div class="main-content">
            ...
            <div class="content">
                <section class="profile-summary">
                    ...
                    <a href="userprofile.php" class="btn">Go to Profile</a>
                </section>
                <section class="account-settings">
                    <h2>Account Settings</h2>
                    <p>Adjust your settings and preferences to fit your needs.</p>
                    <a href="usersettings.php" class="btn">Manage Settings</a>
                </section>
                <section class="recent-activity">
                    <h2>Recent Activity</h2>
                    <p>Check out what’s new and recent in your account.</p>
                    <a href="recentactivity.php" class="btn">See Activities</a>
                </section>
                <section class="help-section">
                    <h2>Need Help?</h2>
                    <p>If you have any questions or need assistance, feel free to reach out!</p>
                    <a href="userhelp.php" class="btn help-btn">Contact Support</a>
                </section>
            </div>
        </div>
    </div>
